...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> implements Filterable {
    ...
    LikeTextNotify buttonTextLikeNotify;
    Profile_postClickNotify buttProfilePostClickNotify;
    public DataAdapter(Context context,ArrayList<DataClass> postListesi) {
        this.context = context;
        this.postListesi = postListesi;
        postfilteredListesi=postListesi;
        try {
            buttonLikeNotify=(MainActivity)context;
            buttonShareNotify =(MainActivity)context;
            buttonCommentNotify=(MainActivity)context;
            buttonTextLikeNotify=(MainActivity)context;
            buttProfilePostClickNotify=(MainActivity)context;
        }catch (Throwable e){
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.location.setText(postfilteredListesi.get(position).getPostLocation());
        ...
        viewHolder.kategori.setText(postfilteredListesi.get(position).getKategori_name());
        ...
        viewHolder.postUpNumber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    buttonTextLikeNotify.onButtonTextLikeClick(position);
                }catch (Throwable e){
                    //interface can be null
                }
            }
        ...
        viewHolder.profilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    buttProfilePostClickNotify.onButtonPicClick(position);
                }catch (Throwable e){
                    //interface can be null
                }
            }
                ...
                if (charString.isEmpty()) {
                    ...
                    for (DataClass androidVersion : postListesi) {
                        ...
                        if (androidVersion.getPostTitle().toLowerCase().contains(charString) || androidVersion.getCountry().toLowerCase().contains(charString)
                                ...
                                ||androidVersion.getNameSurname().toLowerCase().contains(charString)||androidVersion.getPostLocation().toLowerCase().contains(charString)) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            //Listview de bulunan nesnelerin tanımlanması
             ...
             kategori=(TextView)view.findViewById(R.id.textViewkat);
